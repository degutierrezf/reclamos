    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img
                        src="http://vallesdelbiobio.cl/wp-content/uploads/2016/05/valle_bio_bio-189x100.png"></a>
        </div>
...
<div id="intro">
    <div class="container">
        <div class="row">
            ...
            <h3>Concesión Ruta Valles del Biobío</h3>
            <br>
            <div class="col-lg-8">
...
<div class="col-lg-4">
    ...
    <h3><label for="tel">800 370 770</label></h3>

    <hr>

    <h5>Correo Electrónico: </h5>
    <h3><label for="email">rdd.administrativo@saopse.cl</label></h3>

    <hr>

    <h5>Sitio Web: </h5>
    <h3><label>www.rdeldesierto.cl</label></h3>

    <hr>

    <h5>Redes Sociales: </h5>
    <img src="http://www.corporativo.bancoestado.cl/images/default-source/logos/logo-fb.png?sfvrsn=0"> <img
            src="http://www.corporativo.bancoestado.cl/images/default-source/logos/logo-tw.png?sfvrsn=0">
...
<div id="c">
    <div class="container">
        <p>
            <a href="http://www.rdeldesierto.cl"></a><b>Concesionaria Ruta Valles del Biobío</b></a><br/>
