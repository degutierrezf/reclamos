...
<div id="intro">
    <div class="container">
        <div class="row">
            ...
            <h3>Concesión Rutas del Algarrobo</h3>
            <br>
            <div class="col-lg-8">
...
<div class="col-lg-4">
    ...
    <h3><label for="tel">800 364 990</label></h3>
    ...
    <h5>Sitio Web: </h5>
    <h3><label>www.rutadelalgarrobo.cl</label></h3>
...
<div id="c">
    <div class="container">
        <p>
            <a href="http://www.rdeldesierto.cl"></a><b>Concesionaria Rutas del Algarrobo</b></a><br/>
